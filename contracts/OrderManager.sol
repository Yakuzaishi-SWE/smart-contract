...
contract OrderManager {
    ...
    // 0x269Dbe218d78297a00fda4e6628B71dF61006655
        ...
        isStableCoinPegged
    {
        ...
        orderCount++;
        orders[_orderId] = Order(_seller, payable(msg.sender), _amountIn, block.number, block.timestamp, OrderState.Filled);
        ...
        emit OrderConfirmed(_orderId, _seller, payable(msg.sender),  _amountIn,  block.timestamp,  OrderState.Filled);
    }
